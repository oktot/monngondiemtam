...
module.exports = React.createClass({
  ...
  render() {
    ...
    return (
      <html lang="en">
        <head>
		  ...
		  <meta name="google-site-verification" content="L4EZkhygO5No-tj-qHAQUvO7P1h7rXy479xwlIZanGs" />
	...
	<div id="react-mount" style={{width:'100%'}} dangerouslySetInnerHTML={ {    __html: this.props.body} } />
		  ...
		  <script async src='https://www.googletagmanager.com/gtag/js?id=UA-145941798-1' />
...
function buildGoogleAdSense() {
  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: 'ca-pub-7460455793227537',
